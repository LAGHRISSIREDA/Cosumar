...
echo "Validate commit $commitSHA to $destinationOrg"
echo "Modified Files : "
...
sfdx force:source:deploy -p "$modifiedFiles" -u "$destinationOrg" -c --testlevel RunSpecifiedTests --runtests "CTRL018_RelevDePrixController_Test"